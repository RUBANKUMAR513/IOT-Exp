...
function refresh(){
    ...
    dataHTMLformat+='<div class="col-md-6 col-lg-3"><div class="statistic__item statistic__item--green"><h2 class="number">'+item['DeviceName']+'</h2><h4 class="number" style="color: #ffffff;">'+item['Id']+'</h4><div><a class="clicking" href="/individualdashboard.html?id='+item['_Id']+'"></a></div><div style="text-align: end;"><button id="'+item['_Id']+'" onclick="del(this.id)"><i class="fa-solid fa-trash fa-lg" style="color: lightcyan;"></i></button></div></div></div>'
